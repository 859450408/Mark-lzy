package com.lzy.mark.markproduct.exception;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.lzy.mark.markproduct.controller")
public class MarkExceptionControllerAdvice {
